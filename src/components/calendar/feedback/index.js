      ...
      <div className={styles["container"]}>
        ...
        <div className={styles["feedbacks"]}>
          {!isNext ? (
            ...
            array.map((feedback, i) => <Wrap order={i} data={feedback} key={Math.random()}/>)
          )}
        </div>
        <div className={styles["feedbacks-mobile"]}>
          {!isNext ? (
            ...
            arrayMobile.map((feedback, i) => <WrapMobile order={i} data={feedback} key={Math.random()}/>)
          )}
        </div>
        <div
  ...
  return (
    <>
      <div
        className={
          order === 0
            ? styles["wrap-out-mobile"]
            : styles["wrap-left-mobile"]
        }
      >
        <Feedback data={data} order={order} />
      </div>
      ...
      <div className={styles["wrap"] + " " + (!order % 2 && styles["opacity"])}>
        ...
        <div
          className={
            styles["quote"] +
            " " +
            (order % 2 ? styles["quote-green"] : styles["quote-black"])
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
